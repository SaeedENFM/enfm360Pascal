...
const methods ={  
    async loadAppJs(parameters){
      await  loadAppJs(parameters);
    }
};
    ...
    $(document).ready(function () {
        ...
        // (function (window, document, $) {
          // $(function () {
            ...
            // $(document).ready(function () {
              $(document).off('click').on('click', '.menu-toggle, .modern-nav-toggle', function (e) {
                // alert('clicked');
                // Toggle menu
                $.app.menu.toggle();
            ...
            $(document).on('keydown',function (e){ 
              ...
              // console.log(key);
              if(e.ctrlKey && key == 83){
                var searchInput = $('.nav-link-search').parent('.nav-search').find('.search-input');
                searchInput.addClass('open');
                searchInputInputfield.focus();
                searchList.find('li').remove();
                bookmarkInput.removeClass('show');
              }else if(e.ctrlKey && key == 81){
