...
$(document).ready(function() {
  $("#enquiry-form").validate({
      ...
      messages: {
        "enquiry-no": "Please specify your name"
      }
  })
});
...
$(function () {
  ...
  addContactbtForm = $('.add-new-contact'),
  ...
  if (addContactbtForm.length) {
    Array.prototype.filter.call(addContactbtForm, function (form) {
      form.addEventListener('submit', function (event) {
        if (form.checkValidity() === false) {
          form.classList.add('invalid');
        }
